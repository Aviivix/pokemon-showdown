...
export const Formats: FormatList = [
	...
	},
	{
		...
		banlist: [
			...
			'Kyurem-White', 'Landorus-Base', 'Lugia', 'Lunala', 'Magearna', 'Marshadow', 'Mewtwo', 'Naganadel', 'Necrozma-Dawn-Wings', 'Necrozma-Dusk-Mane', 'Palkia', 'Pheromosa',
			'Rayquaza', 'Reshiram', 'Solgaleo', 'Urshifu-Base', 'Xerneas', 'Yveltal', 'Zacian', 'Zacian-Crowned', 'Zamazenta', 'Zamazenta-Crowned', 'Zekrom', 'Zygarde-Base',
	...
	},
	{
		...
		banlist: [
			...
			'Slowbronite',
			// National Dex UU
			'Absol-Mega', 'Aegislash', 'Aggron-Mega', 'Altaria-Mega', 'Alomomola', 'Amoonguss', 'Arctovish', 'Arctozolt', 'Beedrill-Mega', 'Bisharp', 'Breloom', 'Buzzwole', 'Celesteela',
			'Chesnaught', 'Crobat', 'Donphan', 'Dragonite', 'Hippowdon', 'Honchkrow', 'Hoopa-Unbound', 'Infernape', 'Jirachi', 'Keldeo', 'Krookodile',
			'Mamoswine', 'Mandibuzz', 'Manectric-Mega', 'Melmetal', 'Mew', 'Mienshao', 'Moltres-Base', 'Muk-Alola', 'Nihilego', 'Porygon2', 'Porygon-Z', 'Regieleki', 'Ribombee',
			...
			'Lycanroc-Dusk', 'Sharpedo-Mega', 'Obstagoon', 'Moltres-Galar', 'Primarina', 'Reuniclus', 'Salamence', 'Scolipede', 'Tapu Bulu', 'Terrakion', 'Tornadus', 'Venomoth', 'Zeraora',
			'ND RUBL',
		],
		// Used to distinguish RU from below RU in the client
		restricted: [
			'Aerodactyl', 'Arcanine', 'Articuno-Galar', 'Azelf', 'Araquanid', 'Bronzong', 'Celebi', 'Chandelure', 'Chesnaught', 'Cloyster', 'Cobalion', 'Cresselia', 'Crobat', 'Deoxys-Defense', 'Diancie', 'Doublade', 'Emboar', 'Empoleon', 'Feraligatr', 'Flygon', 'Gardevoir', 'Gastrodon', 'Gligar', 'Golisopod', 'Goodra', 'Hatterene', 'Hoopa', 'Houndoom-Mega', 'Incineroar', 'Jellicent', 'Klefki', 'Linoone', 'Lucario', 'Lycanroc', 'Mantine', 'Marowak-Alola', 'Meloetta', 'Metagross', 'Mienshao', 'Milotic', 'Mimikyu', 'Necrozma', 'Nidoking', 'Nidoqueen', 'Noivern', 'Pidgeot-Mega', 'Polteageist', 'Raikou', 'Registeel', 'Rhyperior', 'Roserade', 'Rotom-Mow', 'Salazzle', 'Seismitoad', 'Sharpedo', 'Shaymin', 'Sceptile-Mega', 'Shuckle', 'Sirfetchd', 'Slowbro-Galar', 'Snorlax', 'Stakataka', 'Starmie', 'Steelix-Mega', 'Suicune', 'Sylveon', 'Tentacruel', 'Togekiss', 'Toxtricity', 'Tyrantrum', 'Vaporeon', 'Virizion', 'Volcanion', 'Weezing-Galar', 'Zarude', 'Zoroark', 'Zygarde-10%',
		],
	},
];
